        ...
        <div id="contacts" class="contact-info anchor-target" data-aos="fade-up" data-aos-delay="200">
          <div class="info-card">
            ...
            <div class="info-content">
              <h3>Телефон</h3>
              <p><a href="tel:+79959016488">+7 995 901-64-88</a></p>
            </div>
          </div>
          ...
          <div id="messengers" class="social-links anchor-target">
            ...
            <div class="social-icons">
              <a href="https://t.me/Angelwingspeptides" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Telegram">
